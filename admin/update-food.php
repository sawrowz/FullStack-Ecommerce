...
?>
       ...
       <form action="" method="post" enctype="multipart/form-data">
            <table class="admin-tbl" >
                ...
                <tr>
                    <td>Description:</td>
                    <td>
                        <textarea name="description" id="" cols="30" rows="5" placeholder="Add Description"><?php echo $description;?></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
               ...
               <tr>
                ...
                <tr>
                    <td>
                        ...
                        <input type="submit" name="submit" value="Update Food" class="admin-password">
                    </td>
                </tr>
       ...
       <?php
            if(isset($_POST['submit']))
            {
                ...
                if($res3==true)
                {
                    $_SESSION['update']="<div style='color:green'> Food Updated</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                }
                else
                {
                    $_SESSION['update']="<div style='color:red'> Food Update Failed</div>";
                     header('location:'.SITEURL.'admin/manage-food.php');
                }
